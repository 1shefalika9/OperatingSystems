// SHEFALIKA GHOSH
// 19544
/* Implementing algorithm for non-preemptive Priority Scheduling */
...
int main(int argc, char const *argv[])
{
	...
	cin>>n;
	process p[n];
	cout<<"Enter the burst time and priority of each process--\n";
	for (int i = 0; i < n; ++i)
	{	
		cout<<"\nProcess "<<i+1;
		p[i].pno = i+1;
  ...
  //sorting the processes in increasing order of their priority
	for (int i = 0; i < n; ++i)
	{
		for (int j = i+1; j < n; ++j)
		{
