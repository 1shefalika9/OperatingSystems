//SHEFALIKA GHOSH
//19544
//Program to implement worst fit memory allocation strategy

#include <iostream>
using namespace std;

void sortDesc(int mem[], int block_no[], int blocks){
...
{	
	...
	if(n>blocks)
		...
		//sort the memory blocks in descending order
		sortDesc(mem, block_no, blocks);
